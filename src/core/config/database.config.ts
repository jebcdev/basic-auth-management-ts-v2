...
export class DatabaseConfig {
    ...
    public static readonly type:string = process.env.DB_TYPE || "mysql";  // Obtiene el tipo de base de datos desde variables de entorno o usa "mysql" por defecto.
        ...
        public static readonly database:string = process.env.DB_NAME || "basic-auth-management-ts-v2";  // Obtiene el nombre de la base de datos o usa "basic-auth-management-ts" por defecto.
}
